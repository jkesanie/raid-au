...
public class AccessTypeSchemaRecord extends UpdatableRecordImpl<AccessTypeSchemaRecord> {
    ...
    /**
     * Setter for <code>api_svc.access_type_schema.status</code>.
     */
    public AccessTypeSchemaRecord setStatus(SchemaStatus value) {
        set(2, value);
        return this;
    }

    /**
     * Getter for <code>api_svc.access_type_schema.status</code>.
     */
     ...
     */
    public AccessTypeSchemaRecord(Integer id, String uri, SchemaStatus status) {
        super(AccessTypeSchema.ACCESS_TYPE_SCHEMA);
