...
public class RaidRecord extends UpdatableRecordImpl<RaidRecord> implements Record21<String, Long, String, Integer, String, Boolean, Metaschema, JSONB, LocalDate, LocalDateTime, Integer, String, String, String, Integer, LocalDate, String, Integer, String, Integer, Integer> {
    ...
    @Override
    public Row21<String, Long, String, Integer, String, Boolean, Metaschema, JSONB, LocalDate, LocalDateTime, Integer, String, String, String, Integer, LocalDate, String, Integer, String, Integer, Integer> valuesRow() {
