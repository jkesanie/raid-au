...
public class ContributorSchema extends TableImpl<ContributorSchemaRecord> {
    ...
    /**
     * The column <code>api_svc.contributor_schema.status</code>.
     */
    public final TableField<ContributorSchemaRecord, SchemaStatus> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR.asEnumDataType(au.org.raid.db.jooq.enums.SchemaStatus.class), this, "");
