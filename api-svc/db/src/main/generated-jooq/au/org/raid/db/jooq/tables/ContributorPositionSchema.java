...
public class ContributorPositionSchema extends TableImpl<ContributorPositionSchemaRecord> {
    ...
    /**
     * The column <code>api_svc.contributor_position_schema.status</code>.
     */
    public final TableField<ContributorPositionSchemaRecord, SchemaStatus> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR.asEnumDataType(au.org.raid.db.jooq.enums.SchemaStatus.class), this, "");
