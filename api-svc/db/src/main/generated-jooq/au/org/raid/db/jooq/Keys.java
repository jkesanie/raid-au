...
public class Keys {
    ...
    public static final UniqueKey<ServicePointRecord> UNIQUE_REPOSITORY_ID = Internal.createUniqueKey(ServicePoint.SERVICE_POINT, DSL.name("unique_repository_id"), new TableField[] { ServicePoint.SERVICE_POINT.REPOSITORY_ID }, true);
    ...
    public static final UniqueKey<SubjectTypeRecord> SUBJECT_TYPE_PKEY = Internal.createUniqueKey(SubjectType.SUBJECT_TYPE, DSL.name("subject_type_pkey"), new TableField[] { SubjectType.SUBJECT_TYPE.ID, SubjectType.SUBJECT_TYPE.SCHEMA_ID }, true);
    ...
    public static final ForeignKey<RaidSubjectRecord, SubjectTypeRecord> RAID_SUBJECT__RAID_SUBJECT_SUBJECT_TYPE_FKEY = Internal.createForeignKey(RaidSubject.RAID_SUBJECT, DSL.name("raid_subject_subject_type_fkey"), new TableField[] { RaidSubject.RAID_SUBJECT.SUBJECT_TYPE_ID, RaidSubject.RAID_SUBJECT.SUBJECT_TYPE_SCHEMA_ID }, Keys.SUBJECT_TYPE_PKEY, new TableField[] { SubjectType.SUBJECT_TYPE.ID, SubjectType.SUBJECT_TYPE.SCHEMA_ID }, true);
    public static final ForeignKey<RaidSubjectRecord, SubjectTypeSchemaRecord> RAID_SUBJECT__RAID_SUBJECT_SUBJECT_TYPE_SCHEMA_ID_FKEY = Internal.createForeignKey(RaidSubject.RAID_SUBJECT, DSL.name("raid_subject_subject_type_schema_id_fkey"), new TableField[] { RaidSubject.RAID_SUBJECT.SUBJECT_TYPE_SCHEMA_ID }, Keys.SUBJECT_TYPE_SCHEMA_PKEY, new TableField[] { SubjectTypeSchema.SUBJECT_TYPE_SCHEMA.ID }, true);
