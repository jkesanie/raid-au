...
## 5. Request a refresh token
Access tokens are currently valid for 5 minutes in production after which the user will have to log in again or a new access token can be requested with the refresh token included in the original token response.
```
POST /realms/raid/protocol/openid-connect/token
Host: iam.demo.raid.org.au
Content-Type: application/x-www-form-urlencoded

client_id=test_client&grant_type=refresh_token&client_secret=xxx&refresh_token=eyJhbGciOiJIUzUxMiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIzMDg0MGVhNi1hYjdiLTRmN2UtOGFlNS02MTI5Yzk1YTlhYzEifQ..7zOxnQCXrFEN5eEU4kjFxxzMZbySJqyfMD9kf32pXlMVuxauUUbZ69JpK0v-IiueK8sr0KNVhzdgGphhBWjOOw'
```

The response will include a new access token and refresh token.
```json
{
    "access_token": "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJuZkMtdmoybkE4aGVEN25oMkFDeWI5Nk5ZYUVkTlZuQWVHV2x3bUw0bFEwIn0..a3DE62oPoNKserORQMcXqkCUwd_LFRZt_k4zTv73o6-bkYAkUxqcA7ULRp9XtsmLN7475_NRMmgklwNTLjSt_5lPgahD_GGhwwpH3_of40YyZpnwnVQ24zziSbufM-E_5bnenxw6VlfpDKGFiG4HOeZVY4Z_zyR0zfHLMlMARBH2YKbSCePpLv1er7HlTLMhNIfbouiEQme0DWVzp8DVuPrr1s4pNWSPOpXx0zgSF2PrHDNak6WWi9DQ_4M6YxFHxs0MxYJcpmFjDnWzT1hDqr2ON9_OD3JQ6o2zn7a_RzmvjK3dipmXewc2fQavgiiOUXOxsjPttCHPf2F1iPiAJQ",
    "expires_in": 7162,
    "refresh_expires_in": 7162,
    "refresh_token": "eyJhbGciOiJIUzUxMiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIzMDg0MGVhNi1hYjdiLTRmN2UtOGFlNS02MTI5Yzk1YTlhYzEifQ..ifi6UGfiz_s1PHyA63EKbITmRZtvMgod4AJB-IWWVie7GtxaeYVgG7i1RXJTRaLdix67DXAnCkvYijbWTt0rjw",
    "token_type": "Bearer",
    "not-before-policy": 0,
    "session_state": "7c7dd2d8-8424-43d5-b95b-879bc4bb0f1b",
    "scope": "openid"
}
```