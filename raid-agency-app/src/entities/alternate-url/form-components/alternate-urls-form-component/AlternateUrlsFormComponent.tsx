...
import { AlternateUrlDetailsFormComponent } from "@/entities/alternate-url/form-components/alternate-url-details-form-component";

export function AlternateUrlsFormComponent({
  control,
  errors,
  trigger,
}: {
  ...
  const generator = alternateUrlGenerator;
  const DetailsFormComponent = AlternateUrlDetailsFormComponent;
