...
import { ContributorPositionDetailsFormComponent } from "@/entities/contributor-position/form-components/contributor-position-details-form-component";

export function ContributorPositionsFormComponent({
  control,
  errors,
  trigger,
  parentIndex,
