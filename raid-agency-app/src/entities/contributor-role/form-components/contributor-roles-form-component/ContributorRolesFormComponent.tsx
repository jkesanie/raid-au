...
import { ContributorRoleDetailsFormComponent } from "@/entities/contributor-role/form-components/contributor-role-details-form-component";

export function ContributorRolesFormComponent({
  control,
  errors,
  trigger,
  parentIndex,
  ...
  const generator = contributorRoleGenerator;
  const DetailsFormComponent = ContributorRoleDetailsFormComponent;
