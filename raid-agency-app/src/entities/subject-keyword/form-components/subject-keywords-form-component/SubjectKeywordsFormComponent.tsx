...
import { SubjectKeywordDetailsFormComponent } from "../subject-keyword-details-form-component/SubjectKeywordDetailsFormComponent";

export function SubjectKeywordsFormComponent({
  control,
  errors,
  trigger,
  parentIndex,
