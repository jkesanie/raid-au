...
import { SubjectKeywordsFormComponent } from "@/entities/subject-keyword/form-components/subject-keywords-form-component/SubjectKeywordsFormComponent";
import { SubjectDetailsFormComponent } from "../subject-details-form-component/SubjectDetailsFormComponent";
...
export function SubjectsFormComponent({
  ...
  const generator = subjectGenerator;
  const DetailsFormComponent = SubjectDetailsFormComponent;
