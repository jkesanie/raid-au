...
import { RelatedObjectCategoryDetailsFormComponent } from "@/entities/related-object-category/form-components/related-object-category-details-form-component";
...
export function RelatedObjectCategoriesFormComponent({
  ...
  const parentKey = `relatedObject`;
  const key = `category`;
  const label = "Category";
  const labelPlural = "Categories";
  const generator = relatedObjectCategoryGenerator;
  const DetailsFormComponent = RelatedObjectCategoryDetailsFormComponent;
