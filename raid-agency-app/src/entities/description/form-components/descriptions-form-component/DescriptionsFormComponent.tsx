...
import { DescriptionDetailsFormComponent } from "@/entities/description/form-components/description-details-form-component";
...
export function DescriptionsFormComponent({
  ...
  const DetailsFormComponent = DescriptionDetailsFormComponent;
