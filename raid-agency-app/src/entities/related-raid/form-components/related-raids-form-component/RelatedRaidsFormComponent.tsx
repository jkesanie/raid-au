...
import { RelatedRaidDetailsFormComponent } from "../related-raid-details-form-component/RelatedRaidDetailsFormComponent";
...
export function RelatedRaidsFormComponent({
  ...
  const labelPlural = "Related RAiDs";
  const generator = relatedRaidGenerator;
  const DetailsFormComponent = RelatedRaidDetailsFormComponent;
