...
import { SpatialCoveragePlaceDetailsFormComponent } from "@/entities/spatial-coverage-place/form-components/spatial-coverage-place-details-form-component";
...
export function SpatialCoveragePlacesFormComponent({
  ...
  const generator = spatialCoveragePlaceGenerator;
  const DetailsFormComponent = SpatialCoveragePlaceDetailsFormComponent;
